...
function BurgerMenu_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function BurgerMenu_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, BurgerMenu_toPropertyKey(descriptor.key), descriptor); } }
function BurgerMenu_createClass(Constructor, protoProps, staticProps) { if (protoProps) BurgerMenu_defineProperties(Constructor.prototype, protoProps); if (staticProps) BurgerMenu_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function BurgerMenu_toPropertyKey(arg) { var key = BurgerMenu_toPrimitive(arg, "string"); return BurgerMenu_typeof(key) === "symbol" ? key : String(key); }
function BurgerMenu_toPrimitive(input, hint) { if (BurgerMenu_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (BurgerMenu_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
function _possibleConstructorReturn(self, call) { if (call && (BurgerMenu_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized(self); }
...
var BurgerMenu = /*#__PURE__*/function (_Popup) {
   ...
   */
  BurgerMenu_createClass(BurgerMenu, [{
    key: "init",
    value: function init() {
      var _this2 = this;
...
function Tabs_defineProperty(obj, key, value) { key = Tabs_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = Accordion_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
// Polyfill from NodeList.forEach method
...
;// CONCATENATED MODULE: ./src/js/libs/nouislider.min.js
function nouislider_min_typeof(o) { "@babel/helpers - typeof"; return nouislider_min_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, nouislider_min_typeof(o); }
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : nouislider_min_typeof(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).noUiSlider = {});
}(undefined, function (ot) {
  "use strict";

  function n(t) {
    return "object" == nouislider_min_typeof(t) && "function" == typeof t.to;
  }
  function st(t) {
  ...
  function g(t, e) {
    if ("object" != nouislider_min_typeof(e) || Array.isArray(e)) throw new Error("noUiSlider: 'range' is not an object.");
  ...
  function T(e, r) {
    if ("object" != nouislider_min_typeof(r)) throw new Error("noUiSlider: 'cssClasses' must be an object.");
...
;// CONCATENATED MODULE: ./src/js/modules/Range.js

var rangeSlider = document.getElementById('filters-range-price');
if (rangeSlider) {
  noUiSlider.create(rangeSlider, {
    start: [parseFloat(rangePrices.min), parseFloat(rangePrices.max)],
    connect: true,
    range: {
      'min': parseFloat(rangePrices.min),
      'max': parseFloat(rangePrices.max)
    }
  });
  rangeInputs_init(rangeSlider);
}
function rangeInputs_init(rangeSlider) {
  var input0 = rangeSlider.parentNode.querySelector('#input0');
  var input1 = rangeSlider.parentNode.querySelector('#input1');
  var inputs = [input0, input1];

  inputs.forEach(function (el) {
    el.min = rangePrices.min;
    el.max = rangePrices.max;
  });

  rangeSlider.noUiSlider.on('update', function (values, handle) {
    inputs[handle].value = Math.round(values[handle]); // change round function for numbers
  });

  function rangeInputs_events_set(index, value) {
    var arr = [null, null];
    arr[index] = value;
  ...
  inputs.forEach(function (el, index) {
    el.addEventListener('change', function (e) {
      rangeInputs_events_set(index, e.target.value);
    });
  });
}
;// CONCATENATED MODULE: ./src/js/modules/MultiLevelMenu.js
var multiLevelMenus = document.querySelectorAll('.multiLevelMenu');
multiLevelMenus.forEach(function (multiLevelMenu) {
  var subMenus = multiLevelMenu.querySelectorAll('.submenu');
  subMenus.forEach(function (subMenu) {
    if (subMenu.closest('ul')) {
      subMenu.closest('ul').parentNode.querySelector('a').classList.add('menu-arrow');
    }
  });
});
;// CONCATENATED MODULE: ./src/js/modules/openContentMenu.js
var openContentMenus = document.querySelectorAll('.openContentMenu');
openContentMenus.forEach(function (openContentMenu) {
  var menuContents = openContentMenu.querySelectorAll('.menu-content');
  menuContents.forEach(function (menuContent) {
    if (menuContent) {
      menuContent.parentNode.querySelector('a').classList.add('menu-arrow');
    }
  });
});
...
new core('.hero-slider', {
  ...
  navigation: {
    ...
    disabledClass: 'hero-slider-button-disabled'
  },
  pagination: {
    ...
    bulletActiveClass: 'hero-slider-pagination-bulletActiveClass'
  }
});
...
new core('.products__slider', {
  ...
  pagination: {
    ...
    bulletActiveClass: 'products__slider-pagination-bulletActiveClass'
  },
  breakpoints: {
    877: {
      slidesPerView: 4,
...
new core('.blog__slider', {
  ...
  navigation: {
    ...
    disabledClass: 'blog__slider-button-disabled'
  },
  pagination: {
    ...
    bulletActiveClass: 'blog__slider-pagination-bulletActiveClass'
  }
});
...
new core('.product__slider', {
  ...
  thumbs: {
    swiper: {
      ...
      el: '.product__min_slider',
      slidesPerView: 4,
      slidesPerGroup: 2,
      spaceBetween: 30,
      speed: 600,
      scrollbar: {
        el: '.product__min_slider-scrollbar',
        dragClass: 'product__min_slider-scrollbar-drag',
        draggable: true
      },
      mousewheel: {
        enabled: true,
        eventsTarget: '.product__min_slider'
      }
    }
  }
});
...
new core('.upsells__slider', {
  ...
  slidesPerGroup: 4,
  navigation: {
    prevEl: '.upsells__slider-button-prev',
    nextEl: '.upsells__slider-button-next',
    disabledClass: 'interesting__slider-button-disabled'
  },
  pagination: {
    el: '.upsells__slider-pagination',
    dynamicBullets: true,
    clickable: true,
    renderBullet: function renderBullet(index, className) {
      return '<span class="' + className + '">' + '</span>';
    },
    bulletActiveClass: 'interesting__slider-pagination-bulletActiveClass'
  },
  breakpoints: {
    877: {
      slidesPerView: 4,
...
new core('.interesting__slider', {
  ...
  slidesPerGroup: 4,
  navigation: {
    prevEl: '.interesting__slider-button-prev',
    nextEl: '.interesting__slider-button-next',
    disabledClass: 'interesting__slider-button-disabled'
  },
  pagination: {
    el: '.interesting__slider-pagination',
    dynamicBullets: true,
    clickable: true,
    renderBullet: function renderBullet(index, className) {
      return '<span class="' + className + '">' + '</span>';
...
new modules_Tabs('tabs-single-product-info', {
  onChange: function onChange(data) {
    console.log(data);
  }
});
new modules_Tabs('dashboard-tabs', {
  onChange: function onChange(data) {
    console.log(data);
  }
});
new modules_Accordion('.tab-4__accordion-all-questions', {
  shouldOpenAll: false,
  // true
  defaultOpen: [],
  // [0,1]
...
new modules_Accordion('.tab-4__accordion-products', {
  shouldOpenAll: false,
  // true
  defaultOpen: [],
  // [0,1]
...
new modules_Accordion('.tab-4__accordion-shipping', {
  shouldOpenAll: false,
  // true
  defaultOpen: [],
  // [0,1]
...
new modules_Accordion('.filters__accordion', {
  shouldOpenAll: true,
  // true
...
new modules_Accordion('.order-summary__accordion', {
  shouldOpenAll: true,
  // true
  defaultOpen: [0, 1, 2, 3, 4, 5],
  // [0,1]
...
// Radio description visible

var radioDescriptionVisible = document.querySelectorAll('.payment-details__radio');
var radioDescriptionVisibleDescriptions = document.querySelectorAll('.radio-description');
radioDescriptionVisible.forEach(function (radioWrapper) {
  var radioInput = radioWrapper.querySelector('input[type="radio"]');
  var radioDescription = radioWrapper.querySelector('.radio-description');
  function toggleDescription() {
    radioDescriptionVisibleDescriptions.forEach(function (el) {
      el.style.display = 'none';
    });
    if (radioDescription) {
      if (radioInput.checked) {
        radioDescription.style.display = 'block';
      } else {
        radioDescription.style.display = 'none';
      }
    }
  }
  toggleDescription();
  radioInput.addEventListener('change', toggleDescription);
});

// Add note visible

var addNoteCheckBox = document.querySelector('.add-note__checkbox');
var addNoteInput = addNoteCheckBox.querySelector('input[type="checkbox"]');
var addNoteTextArea = document.querySelector('.add-note__textarea');
function toggleDescription() {
  if (addNoteTextArea) {
    addNoteTextArea.style.display = 'none';
    if (addNoteInput.checked) {
      addNoteTextArea.style.display = 'block';
    } else {
      addNoteTextArea.style.display = 'none';
    }
  }
...
toggleDescription();
addNoteInput.addEventListener('change', toggleDescription);
/******/ })()
;