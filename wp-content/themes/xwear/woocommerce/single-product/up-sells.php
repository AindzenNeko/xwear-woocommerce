...
if ( $upsells ) : ?>
	...
	<section class="up-sells upsells products interesting__shoes">
		<?php
		...
		<?php endif; ?>
		<div class="swiper interesting__slider upsells__slider">
			<div class="swiper-wrapper interesting__slider-wrapper upsells__slider-wrapper">
				<?php //woocommerce_product_loop_start(); ?>
					...
					<?php foreach ( $upsells as $upsell ) : ?>
						...
						<div class="swiper-slide interesting__slider-slide upsells__slider-slide">
							<a class="interesting__slider-slide-favourite" href="<?php echo $upsell->add_to_cart_url(); ?>">
							...
							<a href="<?php echo $upsell->get_permalink();?>" class="interesting__slider-slide-wrapper">
								<div class="interesting__slider-slide-img"><?php echo $upsell->get_image();?></div>
								<div class="interesting__slider-slide-title"><?php echo $upsell->get_title(); ?></div>
								<div class="interesting__slider-slide-price product__price"><?php echo $upsell->get_price_html();?></div>
							</a>
						</div>
			...
			<?php if (count($upsells) > 4): ?>
				<div class="interesting__slider-buttons">
					<div class="interesting__slider-button-prev swiper-button-prev upsells__slider-button-prev">
						<svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M7 13L1 7L7 1" stroke="#121214" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
					</div>
					<div class="interesting__slider-pagination swiper-pagination upsells__slider-pagination"></div>
					<div class="interesting__slider-button-next swiper-button-next upsells__slider-button-next">
						<svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
